...
train_loader = torch.utils.data.DataLoader(train_dataset, batch_size=cfg['batch_size'] // 2, shuffle=True, num_workers=cfg['num_workers'])
test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=cfg['batch_size'] // 2, shuffle=False, num_workers=cfg['num_workers'])
